...
mod tests {
    ...
    const INIT_FILE: &str = ".makima/init.lua";
    const MCP_FILE: &str = ".makima/mcp.toml";
    const CONFIG_FILE: &str = ".makima/config.toml";
    const PERMISSIONS_FILE: &str = ".makima/permissions.toml";
